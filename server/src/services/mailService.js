      ...
      await this.transporter.sendMail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f9f9f9; padding: 20px; border-radius: 8px; max-width: 600px; margin: 0 auto; border: 1px solid #ddd;">
            ...
            <p style="font-size: 16px;">Дякуємо, що приєдналися до нас. Для завершення реєстрації та веріфікації Вашого облікового запису, будь ласка, підтвердіть Вашу електронну адресу, натиснувши на кнопку нижче:</p>
    ...
    try {
      await this.transporter.sendMail({
        ...
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f9f9f9; padding: 20px; border-radius: 8px; max-width: 600px; margin: 0 auto; border: 1px solid #ddd;">
          ...
          <p style="font-size: 16px;">Ви змінили Вашу електронну адресу на ${URL}. Щоб підтвердити нову електронну адресу, будь ласка, натисніть на кнопку нижче:</p>
          <div style="text-align: center; margin: 20px 0;">
